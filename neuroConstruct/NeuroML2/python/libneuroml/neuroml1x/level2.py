...
class NeuroMLLevel2(GeneratedsSuper):
    """Description of neuronal models, including biophysics and channel
    mechanisms (NeuroML Level 2).Unit of all length measurements.
    ...
    subclass = None
    superclass = None
    def __init__(self, volumeUnits='cubic_millimeter', lengthUnits=None, length_units=None, name=None, notes=None, properties=None, annotation=None, group=None, authorList=None, publication=None, neuronDBref=None, modelDBref=None, neuroMorphoRef=None, cells=None, channels=None):
    ...
    def factory(*args_, **kwargs_):
        if NeuroMLLevel2.subclass:
            return NeuroMLLevel2.subclass(*args_, **kwargs_)
        else:
            return NeuroMLLevel2(*args_, **kwargs_)
    ...
    def setChannels(self, channels): self.channels = channels
    ...
    def export(self, outfile, level, namespace_='', name_='NeuroMLLevel2', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='NeuroMLLevel2')
        if self.hasContent_():
            outfile.write('>\n')
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='NeuroMLLevel2'):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='NeuroMLLevel2', fromsubclass_=False):
        ...
        if self.channels is not None:
            self.channels.export(outfile, level, namespace_, name_='channels')
    def hasContent_(self):
        if (
            ...
            return False
    def exportLiteral(self, outfile, level, name_='NeuroMLLevel2'):
        level += 1
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.channels is not None:
            showIndent(outfile, level)
            outfile.write('channels=model_.ChannelML(\n')
            self.channels.exportLiteral(outfile, level, name_='channels')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node):
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'notes':
            ...
            obj_ = ChannelML.factory()
            obj_.build(child_)
            self.setChannels(obj_)
# end class NeuroMLLevel2
...
class Cell(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, name=None, status=None, notes=None, properties=None, annotation=None, group=None, authorList=None, publication=None, neuronDBref=None, modelDBref=None, neuroMorphoRef=None, segments=None, cables=None, cellBody=None, spines=None, freePoints=None, extensiontype_=None):
        self.name = _cast(None, name)
        self.status = status
        self.notes = notes
        self.properties = properties
...
class cellsType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for cell_ in self.cell:
            showIndent(outfile, level)
            outfile.write('model_.Level2Cell(\n')
            cell_.exportLiteral(outfile, level, name_='Level2Cell')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class Level2Cell(Cell):
    """Cell with extensions for biophysics."""
    subclass = None
    superclass = Cell
    def __init__(self, name=None, status=None, notes=None, properties=None, annotation=None, group=None, authorList=None, publication=None, neuronDBref=None, modelDBref=None, neuroMorphoRef=None, segments=None, cables=None, cellBody=None, spines=None, freePoints=None, biophysics=None):
        super(Level2Cell, self).__init__(name, status, notes, properties, annotation, group, authorList, publication, neuronDBref, modelDBref, neuroMorphoRef, segments, cables, cellBody, spines, freePoints, )
        self.biophysics = biophysics
    def factory(*args_, **kwargs_):
        if Level2Cell.subclass:
            return Level2Cell.subclass(*args_, **kwargs_)
        else:
            return Level2Cell(*args_, **kwargs_)
    factory = staticmethod(factory)
    def getBiophysics(self): return self.biophysics
    def setBiophysics(self, biophysics): self.biophysics = biophysics
    def export(self, outfile, level, namespace_='', name_='Level2Cell', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='Level2Cell')
        if self.hasContent_():
            outfile.write('>\n')
            self.exportChildren(outfile, level + 1, namespace_, name_)
            showIndent(outfile, level)
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='Level2Cell'):
        super(Level2Cell, self).exportAttributes(outfile, level, already_processed, namespace_, name_='Level2Cell')
    def exportChildren(self, outfile, level, namespace_='', name_='Level2Cell', fromsubclass_=False):
        super(Level2Cell, self).exportChildren(outfile, level, namespace_, name_, True)
        if self.biophysics is not None:
            self.biophysics.export(outfile, level, namespace_, name_='biophysics')
    def hasContent_(self):
        if (
            self.biophysics is not None or
            super(Level2Cell, self).hasContent_()
            ):
            return True
        else:
            return False
    def exportLiteral(self, outfile, level, name_='Level2Cell'):
        level += 1
        self.exportLiteralAttributes(outfile, level, [], name_)
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        super(Level2Cell, self).exportLiteralAttributes(outfile, level, already_processed, name_)
    def exportLiteralChildren(self, outfile, level, name_):
        super(Level2Cell, self).exportLiteralChildren(outfile, level, name_)
        if self.biophysics is not None:
            showIndent(outfile, level)
            outfile.write('biophysics=model_.Biophysics(\n')
            self.biophysics.exportLiteral(outfile, level, name_='biophysics')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node):
        self.buildAttributes(node, node.attrib, [])
        for child in node:
            ...
            self.buildChildren(child, node, nodeName_)
    def buildAttributes(self, node, attrs, already_processed):
        super(Level2Cell, self).buildAttributes(node, attrs, already_processed)
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'biophysics':
            obj_ = Biophysics.factory()
            obj_.build(child_)
            self.setBiophysics(obj_)
        super(Level2Cell, self).buildChildren(child_, node, nodeName_, True)
# end class Level2Cell
...
def parse(inFileName):
    ...
    if rootClass is None:
        rootTag = 'NeuroMLLevel2'
        rootClass = NeuroMLLevel2
...
def parseString(inString):
    ...
    doc = None
##     sys.stdout.write('<?xml version="1.0" ?>\n')
##     rootObj.export(sys.stdout, 0, name_="NeuroMLLevel2",
##         namespacedef_='xmlns:neuroml="http://morphml.org/neuroml/schema"')
    return rootObj
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
##     sys.stdout.write('#from level2 import *\n\n')
##     sys.stdout.write('import level2 as model_\n\n')
