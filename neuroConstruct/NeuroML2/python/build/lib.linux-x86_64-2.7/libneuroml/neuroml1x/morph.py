...
#
# Generated Wed Feb  1 19:21:09 2012 by generateDS.py version 2.7b_pg.
#
...
##         namespacedef_='xmlns:neuroml="http://morphml.org/morphml/schema"')
    return rootObj
...
def parseString(inString):
    ...
    doc = None
##     sys.stdout.write('<?xml version="1.0" ?>\n')
##     rootObj.export(sys.stdout, 0, name_="Morphology",
##         namespacedef_='xmlns:neuroml="http://morphml.org/morphml/schema"')
    return rootObj
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
##     sys.stdout.write('#from morph import *\n\n')
##     sys.stdout.write('import morph as model_\n\n')
