...
public class IrregularCylindricalRegion extends Region
{
    static final long serialVersionUID = -5457949393L;
    

    public IrregularCylindricalRegion(float x, float y, float z, float radius)
    {
        super.setDescription("IrregularCylindrical");
        
        logger = new ClassLogger("IrregularCylindricalRegion");
    ...
    {
        if (otherObj instanceof IrregularCylindricalRegion)
        {
            IrregularCylindricalRegion other = (IrregularCylindricalRegion) otherObj;
    ...
    public IrregularCylindricalRegion()
    {
        this(0,0,0,100);
    }
    ...
    public Object clone()
    {
        IrregularCylindricalRegion region = new IrregularCylindricalRegion();
    ...
    {
        IrregularCylindricalRegion newSphere = new IrregularCylindricalRegion(this.getCentre().x + trans.x,
    ...
    {
        IrregularCylindricalRegion s = new IrregularCylindricalRegion();
