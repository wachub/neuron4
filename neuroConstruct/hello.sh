...
export NC_HOME=$HOME/neuron4/neuroConstruct
...
export CLASSPATH=$NC_HOME/neuroConstruct_$NC_VERSION.jar:$H5_JARS:$J3D_JARS:$NC_HOME/lib/jython/jython.jar:$LEMS_JAR:$NML2_JAR:/home/job/neuron4/neuroConstruct
...
javac  -sourcepath src -classpath $CLASSPATH  hello.java

echo "here2"

#java -Xmx$NC_MAX_MEMORY  -classpath $CLASSPATH -Djava.library.path=$JAVA_LIBRARY_PATH hello $*


java -Xmx$NC_MAX_MEMORY  -classpath $CLASSPATH hello $*
